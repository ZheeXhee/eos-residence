            ...
            {roomTypes.map((room, index) => (
              <div key={index} className="col-span-2 xl:col-span-1 mb-6 p-0 rounded-lg shadow-sm bg-gray-100">
                <div className="flex flex-col sm:flex-row items-center gap-2 md:gap-6">
                  <img src={room.image.src} alt={room.type} className="w-full sm:w-84 h-72 object-cover rounded-t-lg md:rounded-none md:rounded-tl-lg md:rounded-bl-lg justify-self-center" />
